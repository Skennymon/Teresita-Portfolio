    ...
    <>
      <section className="flex items-center justify-center relative">
        ...
        <div className="absolute flex flex-col items-center justify-center gap-7">
          <h1 className="lg:text-7xl md:text-5xl text-2xl font-main bg-pink-300 rounded-lg p-2 text-yellow-100 font-bitcount-double flex flex-col">
      ...
      >
        ...
        <div className="flex 2xl:flex-row flex-col lg:w-[80%] w-full gap-4 p-4 items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            <p className="2xl:text-5xl text-2xl">
