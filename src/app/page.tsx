      ...
      <section id="aboutme" className="w-full flex flex-col gap-4 items-center justify-between mt-4">
        ...
        <div className="flex 2xl:flex-row flex-col lg:w-[75%] w-full gap-4 p-4">
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            {/*Add a Page for Resume Later*/}
            <Link href="/" className="h-[3rem] md:w-[15rem] rounded-2xl p-7 bg-gray-700 font-main flex items-center justify-center overflow-hidden px-5 py-2.5 text-white duration-300 [transition-timing-function:cubic-bezier(0.175,0.885,0.32,1.275)] active:translate-y-1 active:scale-x-110 active:scale-y-90 hover:-translate-y-1 hover:scale-105 text-center">View my Resume</Link>
