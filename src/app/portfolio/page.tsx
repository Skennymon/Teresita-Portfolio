...
export default function Portfolio() {
  const photos = [
    { src: "/cover/LatinxFashionCover.png", alt: "Latinx Fashion Cover", correspondingPhotos: [{
    ...
    { src: "/cover/GravitiFitnessCover.jpg", alt: "Graviti Fitness Cover", correspondingPhotos: [] },
    { src: "/cover/ZotfestCover.jpg", alt: "Zotfest Cover", correspondingPhotos: [] },
    { src: "/cover/DreamBoyCover.png", alt: "DreamBoys Cover",correspondingPhotos: [] },
    { src: "/cover/EcholaliaDreams.jpg", alt: "Echolalia Dreams Cover", correspondingPhotos: [] },
    {
      src: "/cover/Fashion&SneakersCover.jpg",
      alt: "Fashion & Sneakers Cover",
      correspondingPhotos: [],
    },
    { src: "/cover/LeyMusicVideoCover.jpg", alt: "Ley Music Video Cover", correspondingPhotos: [] },
    {
                ...
                <CarouselContent>
                  {photos.map((photo) => (
                    photo.correspondingPhotos.map((correspondingPhoto) => (
                        <CarouselItem key={correspondingPhoto.src} className="w-full flex items-center justify-center">
                            <Image src={correspondingPhoto.src} alt={correspondingPhoto.alt} width={800} height={800} quality={80}></Image>
                        </CarouselItem>
                    )   
                    )))}
                </CarouselContent>
